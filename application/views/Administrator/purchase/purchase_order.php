					...
					<div class="row">
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label no-padding-right"> Than Qty</label>
									<div class="col-sm-4">
										<input type="text" min="0" id="quantity" name="quantity" class="form-control" placeholder="Than" ref="quantity" v-model="selectedProduct.thanQty" v-on:input="productTotal"/>
									</div>
									<label class="col-sm-1 control-label no-padding-left"> Gauze </label>
									<div class="col-sm-3">
										<input type="text" min="0" id="free" name="free" class="form-control" placeholder="Gauze" v-model="selectedProduct.gauze" v-on:input="productTotal"/>
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:15%;color:#000;">Purchase Rate</th>
							<th style="width:10%;color:#000;">Than</th>
							<th style="width:10%;color:#000;">Gauze</th>
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			productTotal(){
				let thanQty = this.selectedProduct.thanQty ? this.selectedProduct.per_unit_convert * this.selectedProduct.thanQty : 0;
				let gauzeQty = this.selectedProduct.gauze ? this.selectedProduct.gauze : 0;

				this.selectedProduct.quantity = parseFloat(thanQty) + parseFloat(gauzeQty);
			...
			addToCart(){
				...
				let product = {
					...
					thanQty: this.selectedProduct.thanQty ?? 0,
					gauze: this.selectedProduct.gauze ?? 0,
                        ...
                        <div class="col-sm-6">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-4 control-label no-padding-right"> Pur. Rate </label>
                                    <div class="col-xs-3">
                                        <input type="text" id="purchaseRate" name="purchaseRate" class="form-control"
                                    ...
                                    <div class="col-xs-3">
                                        <input type="text" step="0.01" id="quantity" name="quantity"
                                            class="form-control" placeholder="Quantity" ref="quantity"
                                            v-model="selectedProduct.quantity" v-on:input="productTotal" required />
                                    </div>
                                </div>
