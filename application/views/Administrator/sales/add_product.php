    ...
    <form @submit.prevent="saveProduct">
        <div class="row"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Bangla Name:</label>
                    <div class="col-md-7">
                        <input type="text" class="form-control" v-model="product.Product_Bn_Name" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Arabic Name:</label>
                    <div class="col-md-7">
                        <input type="text" class="form-control" v-model="product.Product_Ar_Name" required>
                    </div>
                </div>
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-md-7">
                        <input type="number" step="0.01" min="0" class="form-control"
                            v-model="product.per_unit_convert">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Convert Unit Name:</label>
                    <div class="col-md-7">
                        <input type="text" class="form-control" v-model="product.convert_unit_name" required>
                    </div>
                </div>
                <div class="form-group clearfix">
    ...
    data() {
        return {
            ...
            columns: [{
                ...
                {
                    label: 'Per Unit Convert',
                    field: 'per_unit_convert',
                    align: 'center'
                },
                {
                    label: 'Convert Unit Name',
                    field: 'convert_unit_name',
                    align: 'center'
                },
                {
                    label: 'Action',
