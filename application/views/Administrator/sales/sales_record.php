					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;">{{ sale.saleDetails[0].quantity_display_text }}</td>
					...
					<table class="record-table" v-if="selectedProduct != null">
						...
						<tbody>
							<tr v-for="sale in sales">
								...
								<td style="text-align:center;">{{ sale.quantity_display_text }}</td>
							</tr>
						</tbody>
						<tfoot>
							<tr style="font-weight:bold;">
								<td colspan="5" style="text-align:right;">Total Quantity</td>
								<td style="text-align:center;">{{ sales.reduce((prev, curr) => { return prev + parseFloat(curr.SaleDetails_TotalQuantity)}, 0) }}</td>
							</tr>
						</tfoot>
					</table>
