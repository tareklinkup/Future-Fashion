    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-2">
            ...
            <table class="table custom-table-bordered">
                <thead>
                    <tr>
                        <td class="text-center" colspan="2" style="background-color: #224079;color: white;font-weight: 900;">Worse Product</td>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="(product, sl) in worseProducts">
                        <td width="25%">{{ sl + 1 }}</td>
                        <td width="75%">{{ product.display_text }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        methods: {
            getGraphData(){
                axios.get('/get_graph_data').then(res => {
                    ...
                    this.worseProducts       = res.data.worse_products.filter(item => item.quantity == 0);
