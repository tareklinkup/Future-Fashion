<?php
    class Graph extends CI_Controller{
        ...
        public function getGraphData(){
            ...
            // worse Customers
            $worseProducts = $this->db->query("
                select 
                    concat_ws('-', p.Product_Code, p.Product_Name) as display_text,
                    (
                        select 
                            ifnull(sum(sd.SaleDetails_TotalQuantity), 0) 
