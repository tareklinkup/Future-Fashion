...
class Purchase extends CI_Controller
{
    ...
    public function getPurchases(){
        ...
        if(isset($data->purchaseId) && $data->purchaseId != null){
            ...
            //     $detail->quantity_display_text = floor($detail->PurchaseDetails_TotalQuantity / $detail->per_unit_convert) .' ' . $detail->convert_unit_name . ' ' . $detail->PurchaseDetails_TotalQuantity % $detail->per_unit_convert . ' '. $detail->Unit_Name;
            //     return $detail;
            // }, $purchaseDetails);
        }
    ...
    public function getPurchaseRecord(){
        ...
        foreach($purchases as $purchase){
            ...
            $purchase->purchaseDetails = array_map(function($detail) {
                $detail->quantity_display_text = floor($detail->PurchaseDetails_TotalQuantity / $detail->per_unit_convert) .' ' . $detail->convert_unit_name . ' ' . $detail->PurchaseDetails_TotalQuantity % $detail->per_unit_convert . ' '. $detail->Unit_Name;
                return $detail;
