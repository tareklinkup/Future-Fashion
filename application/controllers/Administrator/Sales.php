...
class Sales extends CI_Controller {
    ...
    public function getSaleDetails(){
        ...
        $saleDetails = array_map(function($detail) {
            $detail->quantity_display_text = floor($detail->SaleDetails_TotalQuantity / $detail->per_unit_convert) .' ' . $detail->convert_unit_name . ' ' . $detail->SaleDetails_TotalQuantity % $detail->per_unit_convert . ' '. $detail->Unit_Name;
            return $detail;
        }, $saleDetails);
